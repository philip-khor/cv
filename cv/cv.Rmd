...
Data scientist with a background in Economics and research experience in applied microeconometrics. Prior experience with regulatory modelling in the financial sector, building deep learning models, driving documentation and advocacy initiatives as well as developing and delivering enterprise data science training courses in statistics and programming.
...
tribble(
  ...
  "CIMB Bank Berhad", "March 2020 - present", "Manager, Regional Advanced Risk Modelling, Group Risk", "Kuala Lumpur", 
  ...
  "Penang Institute", "Dec 2015 - Jan 2016, Aug 2016 - Jan 2017", "Research Assistant: Economics Studies", "George Town, Penang" #, 
  ...
  mutate(Details = list(
    c(
      "Provide technical leadership for development of credit scoring machine
      learning models to meet stakeholder and regulatory expectations, and
      communicating model outcomes with comprehensive model documentation.", 
      "Develop scripts and internal package with R to automate analysis
      on AutoML platform.",
      "Liaise with vendor to ensure comprehensive understanding of AutoML platform 
      processes.",
      "Review and align regulatory expectations for the use of complex modelling 
      methodologies in the development of credit risk ratings models.", 
      "Promote understanding of machine learning algorithms, model explanability and 
      fairness considerations for credit risk ratings models."
    ), 
    ...
    c("Provided key research assistance for the Penang Skilled Workforce Study
       project.",
      ...
      "Emcee at the forum Budgeting Priorities in a Challenging Economic
       ...
       "Contributed to the Penang Economic and Development 
...
```{r}
tribble(
  ~ Institution, ~ Year, ~ Qualification, ~ Where, 
  "Asian Institute of Chartered Bankers", "2022", "Bank Risk Management", "Kuala Lumpur",
  "ASEAN Data Analytics eXchange", "2018", "Data Scientist Trainee", "Bangsar South, Kuala Lumpur", 

) %>% 
  mutate(Details = list(
    c("Provide banking professionals who aspire to be risk specialists with a comprehensive understanding of bank risk management activities."), 
    c("Data science finishing school for graduates covering R and Python 
       programming modules, statistics, data preprocessing, 
       machine learning, data visualisation with 
       programming packages and interactive software, forecasting and 
