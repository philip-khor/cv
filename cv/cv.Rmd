...
tribble(
  ...
  mutate(Details = list(
    ...
    c("Contributed to the Penang Skilled Workforce Study, Penang Economic and Development Report 2015/2016 and the Institute's evaluation of the Trans-Pacific Partnership Agreement (TPPA).", 
