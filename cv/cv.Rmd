...
Data professional with a background in Economics and research experience in applied microeconometrics. Prior experience building proof-of-concept deep learning models and developing and delivering enterprise-level data science training courses in statistics and programming.
...
tribble(
  ...
  mutate(Details = list(
    c("Prepared documentation on internally developed 
       model deployment software, including but not limited to installation 
       and usage instructions and examples, to support internal and external users.",
      "Developed and provided editing assistance for development of training materials.",
      "Provided support and drove community engagement events."),
