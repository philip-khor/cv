...
tribble(
  ...
  mutate(Details = list(
    ...
    c("Involved in the Penang Skilled Workforce Study, Penang Economic and Development Report 2015/2016 and the Institute's evaluation of the Trans-Pacific Partnership Agreement (TPPA).", 
      "Obtaining, sorting and analysing data across a wide array of sources.", 
      "Liaising with government agencies to obtain data.", 
      "Preparing reports and editing report text and formatting.")
  )) %>% 
  tidyr::unnest() %>% 
...
tribble(
  ...
  mutate(details = list(
    c("Econometric analysis of the relationship between parental income and
      ...
      "Attempted a novel identification strategy to estimate the effect of
